...
const HeroSection: React.FC<HeroSectionProps> = ({ saleData, loading }) => {
  ...
  if (loading || !saleData?.sale) {
    return (
      <section className="relative min-h-[80vh] sm:min-h-[85vh] flex items-center justify-center py-16 sm:py-20 px-4 sm:px-6 lg:px-12 overflow-hidden bg-white">
  ...
  return (
    <section
      ...
      className="relative min-h-[80vh] sm:min-h-[85vh] flex items-center justify-center py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12 overflow-hidden bg-white"
    >
      ...
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 items-center relative z-10">
        {/* Left: copy */}
        <motion.div
